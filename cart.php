...
<th><?php echo $c["q"];?></th>
	...
	<?php
	$found = false;
	foreach ($_SESSION["cart"] as $c) { if($c["product_id"]==$r->id_producto){ $found=true; break; }}
	?>
...
<form class="form-horizontal" method="post" action="./php/process.php">
  <div class="form-group">
    ...
    <label for="inputTel3" class="col-sm-2 control-label">Telefono del cliente</label>
    <div class="col-sm-5">
      <input type="tel" name="tel" required class="form-control" id="inputTel3" placeholder="Telefono del cliente">
    </div>
  </div>
  <div class="form-group">
